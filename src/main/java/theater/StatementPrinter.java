...
public class StatementPrinter {
    ...
    public String statement() {
        ...
        for (Performance p : invoice.getPerformances()) {
            ...
            result.append(String.format("  %s: %s (%s seats)%n", getPlay(p).getPlayName(),
    ...
    private int getVolumeCredits(Performance performance) {
        ...
        if ("comedy".equals(getPlay(performance).getPlayType())) {
    ...
    private int getAmount(Performance performance) {
        int result;
        switch (this.getPlay(performance).getPlayType()) {
            case "tragedy":
            ...
            case "comedy":
                ...
                break;
            default:
                throw new RuntimeException(String.format("unknown type: %s", this.getPlay(performance).getPlayType()));
        }
        return result;
    }
